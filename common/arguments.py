...
def parse_args():
    ...
    # distributed mode
    parser.add_argument('--world_size', default=2, type=int, help='num of subprocesses')
    parser.add_argument('--reduce_rank', default=0, type=int, help='the rank to reduce values')
    parser.add_argument('--master_port', type=str, default='6006', help='The port to listen to')
    parser.add_argument('--master_addr', type=str, default='127.0.0.1', help='The address to listen to')
    ...
    parser.add_argument('-b', '--batch_size', default=1024, type=int, metavar='N', help='batch size in terms of predicted frames')
    parser.add_argument('-drop', '--dropout', default=0., type=float, metavar='P', help='dropout probability')
    parser.add_argument('-lr', '--learning_rate', default=0.00006, type=float, metavar='LR', help='initial learning rate')
    parser.add_argument('-lrd', '--lr_decay', default=0.993, type=float, metavar='LR', help='learning rate decay per epoch')
    ...
    parser.add_argument('-f', '--number_of_frames', default='243', type=int, metavar='N',
    ...
    parser.add_argument('--timestep', type=int, default=25, metavar='N', help='timestep')
